...
from account_books.serializers  import AccountBookSerializer, AccountBookDetailSerializer, AccountBookCategorySerializer,\
                                       AccountBookCategoryDetailSerializer

from account_books.models       import AccountBook, AccountBookCategory
from core.utils                 import GetAccountBook, GetAccountBookCategory
...
class AccountBookDetailView(APIView):
    ...
    @swagger_auto_schema(responses={200: '가계부가 삭제되었습니다.'}, manual_parameters=[account_book_id])
...
class AccountBookRestoreView(APIView):
    ...
    @swagger_auto_schema(responses={200: '가계부가 복구되었습니다.'}, manual_parameters=[account_book_id])
    def patch(self, request, account_book_id):
        user = request.user
